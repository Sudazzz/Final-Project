  ...
  textFont('Chiller');
	if (millis()<8000) {
      ...
      stroke(0);
		...
		text('I always said: Mix blue snow, rabbits and yourself.', 250, 700);
      image(rabbit,480,330,200,200);
	}
	else if (millis()<24000) {
		text('Final step! Burn it with creepy piano music!', 600, 100);
      image(rabbit,255,160,200,200);
	}
    else if (millis()<32000) {
		text('Enjoy your popcorn with good Halloween Night!', 250, 700);
