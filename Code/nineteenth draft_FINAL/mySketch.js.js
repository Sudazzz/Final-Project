...
song.setVolume(slider.value());
  ...
  image(video, 100, 100, 200, 200);
    ...
    text("'Mix blood, butter and yourself.'", 400, 800);
		image(video, 700, 700, 200, 200);
    image(video, 500, 500, 200, 200);
    image(video, 300, 300, 200, 200);
    image(video, 100, 100, 200, 200);
    ...
    image(video, 100, 100, 200, 200);
		...
		square(0,0,1000);
		imageMode(CENTER);
		image(video, 500, 500, random(600,800), random(600,800));
	}
		...
		imageMode(CENTER);
		image(video, 500, 500, random(600,800), random(600,800));
		image(butter, 500, 500, random(400,600), random(400,600));
	}
		...
		image(video, 500, 500, random(600,800), random(600,800));
		image(butter, 500, 500, random(400,600), random(400,600));
		image(one, 500, 500, random(200,400), random(200,400));
	}
		...
		image(video, 500, 500, random(600,800), random(600,800));
		image(butter, 500, 500, random(400,600), random(400,600));
		image(two, 500, 500, random(200,400), random(200,400));
	}
		...
		image(video, 500, 500, random(600,800), random(600,800));
		image(butter, 500, 500, random(400,600), random(400,600));
		image(three, 500, 500, random(200,400), random(200,400));
	}
	...
	fill(255,0,0);
		...
		image(video, 500, 500, random(600,800), random(600,800));
		image(butter, 500, 500, random(400,600), random(400,600));
		image(five, 500, 500, random(200,400), random(200,400));
	}
	else if (millis() < 38000) {
	fill(255,0,0);
		square(0,0,1000);
		imageMode(CENTER);
		image(video, 500, 500, random(600,800), random(600,800));
		image(butter, 500, 500, random(400,600), random(400,600));
		image(six, 500, 500, random(200,400), random(200,400));
	}
	...
	fill(255,0,0);
		...
		image(video, 500, 500, random(600,800), random(600,800));
		image(butter, 500, 500, random(400,600), random(400,600));
		image(seven, 500, 500, random(200,400), random(200,400));
	}
		else if (millis() < 42000) {
		imageMode(CORNER);
		laugh.play();
		background(0);
...
//basiclly use time to tell a story;
  video.loadPixels();
