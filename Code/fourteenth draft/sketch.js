...
class Popcorn
  ...
  update() {
    ...
    if ((this.position.x > this.xborder) || (this.position.y < this.yborder)) {
  ...
  display() {
    ...
    stroke(0);
    fill(175);
    image(seven,this.position.x, this.position.y, 80,80);
  }
  }
...
function setup() { 
  ...
  Spopcorn = new Popcorn(84,850,0,-15,850,310);
  VIpopcorn = new Popcorn(250,850,0,-15,850,510);
