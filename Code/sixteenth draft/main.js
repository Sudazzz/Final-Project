...
function setup() {
  ...
  console.log(
    "press mouse to spray snow and play or stop music, click snap to take picture."
  );
  //sue camera
  video = createCapture(
    {
  ...
  //call popcorn
  Spopcorn = new Popcorn(84, 850, 0, -10);
  VIpopcorn = new Popcorn(310, 850, 0, -10);
  Vpopcorn = new Popcorn(540, 850, 0, -10);
  IVpopcorn = new Popcorn(780, 850, 0, -10);
  IIIpopcorn = new Popcorn(780, 50, 0, 10);
  IIpopcorn = new Popcorn(540, 50, 0, 10);
  Ipopcorn = new Popcorn(310, 50, 0, 10);
}
...
function draw() {
  ...
  VIpopcorn.update(850, 450);
  VIpopcorn.display(six);
  Vpopcorn.update(850, 595);
  Vpopcorn.display(five);
  IVpopcorn.update(850, 750);
  IVpopcorn.display(four);
  IIIpopcorn.update(630, 50);
  IIIpopcorn.display(three);
  IIpopcorn.update(420, 50);
  IIpopcorn.display(two);
  Ipopcorn.update(230, 50);
